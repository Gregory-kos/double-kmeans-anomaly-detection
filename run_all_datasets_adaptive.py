#!/usr/bin/env python3
"""
Script to run detection_noPCA_adaptive.py on all datasets
"""
...
def run_detection(file_path):
    """Run adaptive detection script on a file"""
    print(f"\n{'='*80}")
    print(f"🔍 Processing: {file_path}")
    print(f"{'='*80}\n")

    cmd = [sys.executable, "detection_noPCA_adaptive.py", file_path]
...
def main():
    """Main function"""
    print("="*80)
    print("🚀 BATCH PROCESSING - ADAPTIVE OUTLIER DETECTION (NO PCA)")
    print("="*80)
    print("\n💡 This method uses FULLY ADAPTIVE parameters:")
    ...
    # Summary
    print("\n\n" + "="*80)
    print("📋 BATCH PROCESSING SUMMARY (ADAPTIVE)")
    print("="*80)
