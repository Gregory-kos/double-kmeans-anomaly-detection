#!/usr/bin/env python3
"""
Script to run detection_noPCA_mahalanobis.py on all datasets
"""
...
def run_detection(file_path):
    """Run detection script on a file"""
    print(f"\n{'='*80}")
    print(f"🔍 Processing: {file_path}")
    print(f"{'='*80}\n")

    cmd = [sys.executable, "detection_noPCA_mahalanobis.py", file_path]
...
def main():
    """Main function"""
    print("="*80)
    print("🚀 BATCH PROCESSING - MAHALANOBIS DISTANCE")
    print("="*80)
    ...
    # Summary
    print("\n\n" + "="*80)
    print("📋 BATCH PROCESSING SUMMARY (MAHALANOBIS)")
    print("="*80)
